...
- `docs/release_profile_smoke.md` — exact-package optimized boot/render smoke gate across all 18 scenes.
...
The smoke gate then proves the packaged EXE matches the release build, renders all 18 seeded scenes
