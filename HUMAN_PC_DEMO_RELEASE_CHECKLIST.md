...
- [ ] Review every native-size image in the candidate-stamped four-resolution packet generated by
  `scripts/create_visual_review_packet.ps1`; record failures and issue IDs in its blank review file.
...
- [ ] Resolve every human-decision marker in the candidate-stamped storefront packet generated by
  `scripts/create_storefront_review_packet.ps1`; do not publish the proposed copy unchanged.
