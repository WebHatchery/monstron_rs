...
#>
param(
    [string[]]$Scenes = @("mainmenu", "new_game_warning", "save_recovery", "autosave_notice", "save_reset_warning", "help", "settings", "town", "hatchery", "stable", "breeding", "workshop", "shop", "tower", "combat"),
    [int]$Frames = 150,
