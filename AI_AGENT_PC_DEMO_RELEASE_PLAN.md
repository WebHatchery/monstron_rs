...
- Save/load is a single manual slot. There is no visible autosave, destructive New Game warning, save-location help, backup/recovery flow, or corrupt-save quarantine exposed to the player.
