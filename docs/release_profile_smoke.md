...
8. boots the same executable again in 1366×768 and 960×540 windows plus 1920×1080 fullscreen,
   validating all 64 scene outputs as nontrivial PNGs with exact dimensions; then
...
Current baseline: all 16 scenes pass at all four resolutions. Five fresh-process 1280×720
development-machine runs had a worst p95 update+draw time of 0.830 ms. A diagnostic first-use
