...
- Change-aware autosave, New Game confirmation, and separately confirmed save reset are implemented;
  save-location help and supported-version migration gates remain.
